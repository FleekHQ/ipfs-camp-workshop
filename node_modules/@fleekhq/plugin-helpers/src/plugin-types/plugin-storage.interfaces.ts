...
export type PluginStorageObjectType = 'folder' | 'file';
...
export interface PluginStorageCommonMethodOptions<
...
export interface PluginStorageGetMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {}

export interface PluginStorageDownloadMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  objectId: string;
...
export interface PluginStorageUploadMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export type PluginStorageUploadMethodReturn =
  | {
      instanceFields?: PluginCommonMethodOptions['instanceFields'];
    }
  | undefined;

export interface PluginStorageDeleteMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export interface PluginStorageRenameMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export interface PluginStorageMoveMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export interface PluginStorageDuplicateMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export interface PluginStorageCreateFolderMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export interface PluginStorageDeleteFolderMethodOptions<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends PluginStorageCommonMethodOptions<AuthenticationCredential, InstanceField> {
  /**
...
export abstract class PluginStorage<
  AuthenticationCredential extends string = string,
  InstanceField extends string = string
> extends Plugin<AuthenticationCredential, InstanceField> {
  constructor(info: Omit<PluginInfo<AuthenticationCredential, InstanceField>, 'type'>) {
    super({ ...info, type: 'STORAGE' });
  }
  /**
   ...
   */
  public abstract get(
    options: PluginStorageGetMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<PluginStorageGetMethodReturn>;
  /**
   * Upload an object.
  ...
  public abstract upload(
    options: PluginStorageUploadMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<PluginStorageUploadMethodReturn>;
  /**
   * Delete an object.
  ...
  public abstract delete(
    options: PluginStorageDeleteMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<void>;
  /**
   * Rename an object.
  ...
  public abstract rename(
    options: PluginStorageRenameMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<void>;
  /**
   ...
   * @throws Error if the plugin is not initialized.
   */
  public abstract move(options: PluginStorageMoveMethodOptions<AuthenticationCredential, InstanceField>): Promise<void>;
  /**
   * Duplicate an object.
  ...
  public abstract duplicate(
    options: PluginStorageDuplicateMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<void>;
  /**
   * Create a folder.
  ...
  public abstract createFolder(
    options: PluginStorageCreateFolderMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<void>;
  /**
   * Delete a folder.
  ...
  public abstract deleteFolder(
    options: PluginStorageDeleteFolderMethodOptions<AuthenticationCredential, InstanceField>
  ): Promise<void>;
}
