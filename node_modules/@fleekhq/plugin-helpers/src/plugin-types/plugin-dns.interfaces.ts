...
export interface PluginDnsVerifyDomainMethodOptions<FieldName extends string>
  extends PluginDnsCommonMethodOptions<FieldName> {
  /**
...
export interface PluginDnsGetDomainInfoMethodOptions<FieldName extends string>
  extends PluginDnsCommonMethodOptions<FieldName> {}
...
export abstract class PluginDns<FieldName extends string> extends Plugin<FieldName> {
   ...
   */
  public abstract getDomainInfo(
    options: PluginDnsGetDomainInfoMethodOptions<FieldName>
  ): Promise<PluginDnsGetDomainInfoMethodReturn>;
  /**
   ...
   * @throws Error if the plugin is not initialized.
   */
  public abstract verifyDomain(options: PluginDnsVerifyDomainMethodOptions<FieldName>): Promise<PluginDnsObject>;
}
